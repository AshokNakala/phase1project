...
class FileOperation
{
	 static int choice;
	 static int Fchoice;
	 static String location = "C:\\project";
				 		...
				 		do
				 		{
							...
							switch(Fchoice) 
							{
								...
								case 3:
									...
									st = sc.next();
									File fsearch = new File("C:\\project");
...
public class LockedMe {
	...
	public static void main(String[] args) throws IOException {
		...
		File mFolder =new File("C:\\project");
